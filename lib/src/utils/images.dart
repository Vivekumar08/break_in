...
class Images {
  ...
  static Image get canteen => Image.asset("$_initialPath/Canteen.jpg", scale: 4);
  static Image get corners => Image.asset("$_initialPath/Canteen1.jpg", scale: 4);
  static Image get others => Image.asset("$_initialPath/corner.jpg", scale: 4);
  static Image get microCafe => Image.asset("$_initialPath/microcafe.jpg", scale: 4);
  static Image get hostelMess => Image.asset("$_initialPath/hostelmess.jpg", scale: 4);
}
